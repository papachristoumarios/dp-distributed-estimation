...
python3 mean_estimation.py --name germany_consumption --protect_network --eps 1 --distribute_budget --eps_upper_bound 5
python3 mean_estimation.py --name germany_consumption --intermittent --protect_network --eps 10 --distribute_budget --eps_upper_bound 50
python3 mean_estimation.py --name germany_consumption --task mse_plot --distribute_budget
